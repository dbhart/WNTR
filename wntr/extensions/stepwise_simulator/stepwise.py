...
class StepwiseEpanetSimulator(WaterNetworkSimulator):
    ...
    def open(
        ...
        self._wn: wntr.network.WaterNetworkModel = wn
        self._file_prefix: str = file_prefix
        self._save_hyd: bool = save_hyd
        self._use_hyd: bool = use_hyd
        self._hydfile: str = hydfile
        self._version: float = 2.2
        self._T_maximum: int = maximum_duration
        self._convergence_error: float = convergence_error
        self._estimated_results_size: int = estimated_results_size
        self._stop_criteria: StopCriteria = (
