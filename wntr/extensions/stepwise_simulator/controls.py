...
class StatusChangeCondition(ControlCondition):
    ...
    def name(self):
        ...
        return "{}:{}{}".format(obj, "status->", str(self._activation) if self._activation else "ANY")

    def __repr__(self):
        return "<StatusChangeCondition: {}, {}>".format(str(self._source_obj), str(self._activation))
